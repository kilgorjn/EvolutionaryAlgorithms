...
class ParParameter{
	...
	public static IEAlgorithm initializeEAlgorithm(){	// Design Pattern Strategy
		IEAlgorithm algorithm = null;
		switch(eAlg){
			case 0: algorithm = new SGA(eaParamFile); break;
			case 1: algorithm = new UMDA(eaParamFile); break;
			case 2: algorithm = new ECGA(eaParamFile); break;
			case 3: algorithm = new HBOA(eaParamFile); break;
			default: exitError("If you are reading this message something is FUNDAMENTALLY WRONG with the validation of the 'eAlg' value.\n" + 
			   				"You may contact the author at 'unidadeimaginaria@gmail.com'\n" +
			   				"Sorry for the inconvenience!");
	 				 // This line is never executed!
				algorithm = new HBOA(eaParamFile);
		}
		System.out.println("HEYYYYYYYYYYYYY!!!!!  "+algorithm.getName());
		return algorithm;
	}
